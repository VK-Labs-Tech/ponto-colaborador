<div>
    <form method="POST" action="{{ route('employees.store') }}" class="row g-3">
        ...
        <div class="col-12 col-md-6">
            ...
            <input class="form-control" type="time" name="shift_start" value="{{ old('shift_start') }}" required>
        </div>

        <div class="col-12 col-md-6">
            <label class="form-label">Saida para almoço</label>
            <input class="form-control" type="time" name="lunch_start" value="{{ old('lunch_start') }}" required>
        </div>
